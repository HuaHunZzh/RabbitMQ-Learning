...
public class Worker02 {
    public static void main(String[] args) {
        ...
        try {
            ...
            //声明一个随机名字的临时队列
            channel.queueDeclare(RabbitMqConstant.RABBITMQ_QUEUE_NAME_DIRECT_WOKER02, false, false, false,null);
            //绑定交换机与队列
            channel.queueBind(RabbitMqConstant.RABBITMQ_QUEUE_NAME_DIRECT_WOKER02,
                    RabbitMqConstant.RABBITMQ_EXCHANGE_NAME_DIRECT,
                    RabbitMqConstant.RABBITMQ_ROUTINGKEYS_NAME_DIRECT_WORKER02_KEY1);
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        try {
            channel.basicConsume(RabbitMqConstant.RABBITMQ_QUEUE_NAME_DIRECT_WOKER02,true,deliverCallback,cancelCallback);
